    ...
    content:
      ...
      items:
        - title: 高级生物医学科学家
          ...
          company_url: 'www.femtoresearch.com.cn/'
          company_logo: org-FAR
          location: 广州
          date_start: '2025-03-24'
          date_end: ''
          description: |2-
              工作课题：“飞秒激光无标记影像”（FLI）技术在活细胞成像领域的应用开发

              工作内容：
              * 负责公司在活细胞领域对外交流、客户合作及应用场景开发
              * 负责适用于活细胞成像的飞秒激光无标记影像设备的开发
              * 负责飞秒激光无标记影像设备在外泌体、干细胞、胚胎及类器官等领域的应用开发
